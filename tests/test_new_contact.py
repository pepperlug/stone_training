...
def test_new_contact_nophone(app):
    app.contact.add_new_contact(FeaturesContact(firstname="Cercei", middlename="Snow", lastname="Aegon", nickname="Targaryen",title="north", company="night watch", address="black castle",home="111", mobile="222", work="333",fax="dark dozor"))
